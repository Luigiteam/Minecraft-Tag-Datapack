...
execute if score maxHeight Toggle matches 0 run item replace entity @s container.22 with feather[custom_data={Floating:1b,Kill:1b},custom_name='{"text":"World Height Settings","italic":false,"color": "red"}']
item modify entity @s container.22 {function:"minecraft:set_lore",entity:"this",lore:[[{text:"The Max World Height is currently Y ",italic:false,"color":"white"},{score:{name:"maxHeight",objective:"Numbers"},"color":"light_purple"}],[{text:"This forces players under the height limit."}],[{text:"Click the feather to enable/disable"}],[{text:"Max: ",color:"white"},{text:"300",color:"light_purple"},{text:" Blocks High"}],[{text:"Min: ",color:"white"},{text:"150",color:"light_purple"},{text:" Blocks High",color:"white"}]],mode:"replace_all"}
...
execute if score minDepth Toggle matches 0 run item replace entity @s container.31 with deepslate[custom_data={Floating:1b,Kill:1b},custom_name='{"text":"World Depth Settings","italic":false,"color": "red"}']
item modify entity @s container.31 {function:"minecraft:set_lore",entity:"this",lore:[[{text:"The Min World Depth is currently Y ",italic:false,"color":"white"},{score:{name:"minDepth",objective:"Numbers"},"color":"light_purple"}],[{text:"This forces players over the Depth limit."}],[{text:"Click the deepslate to enable/disable"}],[{text:"Max: Y ",color:"white"},{text:"30",color:"light_purple"}],[{text:"Min: Y ",color:"white"},{text:"-30",color:"light_purple"}]],mode:"replace_all"}
