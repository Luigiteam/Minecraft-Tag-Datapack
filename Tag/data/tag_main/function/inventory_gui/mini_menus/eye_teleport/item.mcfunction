...
item replace entity @s container.18 with gray_stained_glass_pane[minecraft:custom_data={Kill:1b},minecraft:item_model="main:tag_default",minecraft:custom_name='{"text":"Add Weight by 1","color": "green"}',minecraft:lore=['{"text": "This resets the weight to 2"}']] 1
$item replace entity @s container.19 with ender_eye[minecraft:custom_data={Kill:1b},lore=['[{"text": "Currently the weight is ","color":"white"},{"text":"$(eyeTeleport)","color":"dark_purple"}]'],minecraft:enchantment_glint_override=true,minecraft:custom_name='{"text":"Eye of Teleportation","color":"green"}'] 1
