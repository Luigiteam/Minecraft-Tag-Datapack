...
$item replace entity @s container.19 with splash_potion[lore=['[{"text": "Currently the weight is ","color":"white"},{"text":"$(potionInvis)","color":"dark_purple"}]'],minecraft:enchantment_glint_override=true,minecraft:custom_name='{"text":"Potion of Invisibility","color":"white"}',potion_contents={custom_color:16777215},minecraft:custom_data={Kill:1b}] 1
