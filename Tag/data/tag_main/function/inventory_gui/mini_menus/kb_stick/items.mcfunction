...
item replace entity @s container.18 with gray_stained_glass_pane[minecraft:custom_data={Kill:1b},minecraft:item_model="main:tag_default",minecraft:custom_name='{"text":"Add Weight by 1","color": "green"}',minecraft:lore=['{"text": "This resets the weight to 5"}']] 1
$item replace entity @s container.19 with wooden_sword[minecraft:custom_data={Kill:1b},lore=['[{"text": "Currently the weight is ","color":"white"},{"text":"$(kbStick)","color":"dark_purple"}]'],minecraft:enchantment_glint_override=true,minecraft:custom_name='{"text":"Knock Back Stick","color":"red"}',minecraft:item_model="minecraft:stick"] 1
