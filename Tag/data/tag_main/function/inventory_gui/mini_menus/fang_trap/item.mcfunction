...
$item replace entity @s container.19 with polar_bear_spawn_egg[lore=['[{"text": "Currently the weight is ","color":"white"},{"text":"$(fangTrap)","color":"dark_purple"}]'],minecraft:enchantment_glint_override=true,minecraft:custom_name='{"text":"Fang Trap","color":"gold"}',minecraft:custom_data={Kill:1b}] 1
