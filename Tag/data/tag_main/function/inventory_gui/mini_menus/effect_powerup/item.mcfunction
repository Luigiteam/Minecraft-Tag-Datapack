...
$item replace entity @s container.19 with potion[minecraft:custom_data={Kill:1b},lore=['[{"text": "Currently the weight is ","color":"white"},{"text":"$(effectPowerup)","color":"dark_purple"}]'],minecraft:enchantment_glint_override=true,minecraft:custom_name='{"text":"Effect Powerups","color":"white"}',minecraft:item_model="main:tag_player_revealer"] 1
