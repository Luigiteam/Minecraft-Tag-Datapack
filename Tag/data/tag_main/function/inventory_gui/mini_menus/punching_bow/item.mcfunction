...
$item replace entity @s container.19 with bow[minecraft:custom_data={Kill:1b},lore=['[{"text": "Currently the weight is ","color":"white"},{"text":"$(punchBow)","color":"dark_purple"}]'],minecraft:enchantment_glint_override=true,minecraft:custom_name='{"text":"Punching Bow","color":"gray"}'] 1
