...
execute if score sec Toggle matches 0 run item modify entity @s container.22 {function:"minecraft:set_lore",entity:"this",lore:[[{text:"The time is currently ",italic:false,"color":"white"},{score:{name:"minutes",objective:"gameTimer"},"color":"light_purple"},{text:" Minutes"}],[{text:"Max: ",color:"white"},{text:"10 ",color:"light_purple"},{text:"minutes",color:"white"}],[{"text":"Min: ",color:"white"},{text:"2 ",color:"light_purple"},{text:"minutes",color:"white"}]],mode:"replace_all"}
execute if score sec Toggle matches 1 run item modify entity @s container.22 {function:"minecraft:set_lore",entity:"this",lore:[[{text:"The time is currently ",italic:false,"color":"white"},{score:{name:"minutes",objective:"gameTimer"},"color":"light_purple"},{text:":30",color:"light_purple"}],[{text:"Max: ",color:"white"},{text:"10 ",color:"light_purple"},{text:"minutes",color:"white"}],[{"text":"Min: ",color:"white"},{text:"2 ",color:"light_purple"},{text:"minutes",color:"white"}]],mode:"replace_all"}
