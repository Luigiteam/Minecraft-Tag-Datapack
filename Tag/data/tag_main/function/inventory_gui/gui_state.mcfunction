...
execute as @s if entity @s[nbt={Inventory:[{Slot:8b}]}] run scoreboard players set @s guiUpdate 1
...
execute as @s at @s if score @s guiState matches 3 unless score @s guiDelay matches 1.. run function tag_main:inventory_gui/gui_detection_page_3
execute as @s at @s if score @s guiState matches 3 if score @s guiUpdate matches 1 run function tag_main:inventory_gui/gui_page_3