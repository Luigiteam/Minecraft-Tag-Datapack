...
execute if score @s teamChoose matches 2 run item replace entity @s container.30 with leather_boots[minecraft:custom_data={Kill:1b},minecraft:custom_name='[{"text": "Click me to join Runners!","color": "green"}]',minecraft:enchantment_glint_override=1b] 1
execute unless score @s teamChoose matches 2 run item replace entity @s container.30 with leather_boots[minecraft:custom_data={Kill:1b},minecraft:custom_name='[{"text": "Click me to join Runners!","color": "green"}]',minecraft:enchantment_glint_override=0b] 1

execute if score @s teamChoose matches 1 run item replace entity @s container.32 with iron_sword[minecraft:custom_data={Kill:1b},minecraft:custom_name='[{"text": "Click me to join Taggers!","color": "red"}]',minecraft:enchantment_glint_override=1b] 1
execute unless score @s teamChoose matches 1 run item replace entity @s container.32 with iron_sword[minecraft:custom_data={Kill:1b},minecraft:custom_name='[{"text": "Click me to join Taggers!","color": "red"}]',minecraft:enchantment_glint_override=0b] 1
