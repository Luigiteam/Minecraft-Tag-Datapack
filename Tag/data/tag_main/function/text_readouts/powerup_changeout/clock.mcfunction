...
execute if score settingSet optionsSelect matches 1 if score clock Toggle matches 1 run tellraw @a [{"text": "The "},{"text": "Clock of Destiny ","color": "yellow"},{"text": "is disabled","color": "white"}]
...
execute if score settingSet optionsSelect matches 0 if score clock Toggle matches 0 run tellraw @a [{"text": "The "},{"text": "Clock of Destiny ","color": "yellow"},{"text": "is enabled","color": "white"}]
