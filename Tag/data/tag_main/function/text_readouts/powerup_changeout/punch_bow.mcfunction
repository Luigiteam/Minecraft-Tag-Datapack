...
execute if score settingSet optionsSelect matches 1 if score punchBow Toggle matches 1 run tellraw @a [{"text": "The "},{"text": "Punching Bow ","color": "red"},{"text": "is disabled","color": "white"}]
...
execute if score settingSet optionsSelect matches 0 if score punchBow Toggle matches 0 run tellraw @a [{"text": "The "},{"text": "Punching Bow ","color": "red"},{"text": "is enabled","color":"white"}]
