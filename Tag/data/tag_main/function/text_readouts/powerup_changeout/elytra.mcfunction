...
execute if score settingSet optionsSelect matches 1 if score elytra Toggle matches 1 run tellraw @a [{"text": "The "},{"text": "Elytra of Soaring ","color": "light_purple"},{"text": "is disabled","color": "white"}]
...
execute if score settingSet optionsSelect matches 0 if score elytra Toggle matches 0 run tellraw @a [{"text": "The "},{"text": "Elytra of Soaring ","color": "light_purple"},{"text": "is enabled","color": "white"}]
