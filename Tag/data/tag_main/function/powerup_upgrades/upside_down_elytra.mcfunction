...
summon item ~ ~ ~ {Item:{id:"minecraft:elytra",components:{"minecraft:custom_name":'[{"text":"Upside-Down Elytra","italic":false,"color":"dark_purple"}]',"minecraft:custom_data":{Floating:1b,Upgrade:1b},"minecraft:lore":['[{"text":"When put on, this will take you down 30 blocks,"}]','[{"text":"destroying anyblock in your way!"}]'],"minecraft:item_model":"main:tag_updown_elytra"}}}
