...
execute as @a[tag=runner,scores={heartBeatSpeed=1..}] at @s if entity @a[tag=tagger,distance=..31] if score State gameStart matches 1.. if score gameMode Toggle matches 5 run scoreboard players add @s heartBeatTimer 1
...
execute as @a[tag=runner,scores={heartBeatSpeed=1}] at @s if score @s heartBeatTimer matches 20 run playsound minecraft:entity.warden.heartbeat ambient @s ~ ~ ~ 1 0.5

execute as @a[tag=runner,scores={heartBeatSpeed=2}] at @s if score @s heartBeatTimer matches 10 run playsound minecraft:entity.warden.heartbeat ambient @s ~ ~ ~ 1 1.0

execute as @a[tag=runner,scores={heartBeatSpeed=3}] at @s if score @s heartBeatTimer matches 5 run playsound minecraft:entity.warden.heartbeat ambient @s ~ ~ ~ 1 1.5
...
# Pre-Game
execute if score State gameStart matches 0 at @e[type=marker,tag=spawn] run tp @a[distance=9..] ~ ~2 ~
...
execute at @e[type=marker,tag=snowballs] unless entity @e[type=snowball,distance=..2] run fill ~-2 ~-2 ~-2 ~2 ~2 ~2 air destroy
