...
execute if score settingSet optionsSelect matches 1 if score snowball Toggle matches 1 run tellraw @a [{"text": "The "},{"text": "Snowball of Destruction ","color": "aqua"},{"text": "is disabled","color": "reset"}]
...
execute if score settingSet optionsSelect matches 0 if score snowball Toggle matches 0 run tellraw @a [{"text": "The "},{"text": "Snowball of Destruction ","color": "aqua"},{"text": "is enabled","color": "reset"}]
