...
execute if score settingSet optionsSelect matches 1 if score eyeTeleport Toggle matches 1 run tellraw @a [{"text": "The "},{"text": "Eye of Teleportation ","color": "green"},{"text": "is disabled","color": "reset"}]
...
execute if score settingSet optionsSelect matches 0 if score eyeTeleport Toggle matches 0 run tellraw @a [{"text": "The "},{"text": "Eye of Teleportation ","color": "green"},{"text": "is enabled","color": "reset"}]
