...
execute at @a[tag=posTemp] run summon armor_stand 0 -64 0 {Invisible:1b,Invulnerable:1b,NoGravity:1b,Tags:[POS1]}
execute at @a[tag=posTemp] run summon armor_stand 0 -64 0 {Invisible:1b,Invulnerable:1b,NoGravity:1b,Tags:[POS2]}
execute at @a[tag=posTemp] run summon armor_stand 0 -64 0 {Invisible:1b,Invulnerable:1b,NoGravity:1b,Tags:[POS3]}
execute at @a[tag=posTemp] run summon armor_stand 0 -64 0 {Invisible:1b,Invulnerable:1b,NoGravity:1b,Tags:[POS4]}
...
## Item 2 (Clamp Trap)
#give @s polar_bear_spawn_egg{EntityTag:{id:"minecraft:area_effect_cloud",Tags:[ClampTrap],Color:16743168,Particle:"ambient_entity_effect 1 0 0 1",Age:0,WaitTime:0,Duration:36656,Radius:4.5f}} 1
#summon area_effect_cloud ~ ~ ~ {Color:16743168,Particle:"ambient_entity_effect 1 0 0 1",Age:0,WaitTime:0,Duration:36656,Radius:4.5f}
execute if score Type Powerup matches 2 at @e[tag=positioned] run summon minecraft:item ~ ~280 ~ {Item:{id:"minecraft:polar_bear_spawn_egg",Count:1b,tag:{Floating:1b,Glowing:1b,EntityTag:{id:"minecraft:area_effect_cloud",Tags:[ClampTrap],Particle:"ambient_entity_effect 1 0 0 1",Age:0,WaitTime:0,Duration:6000,Radius:4.5f},display:{Name:'[{"text":"Clamp Trap","italic":false}]',Lore:['[{"text":"Right click on any block to set this trap up about 5","italic":false}]','[{"text":"block radius... But be careful, you may walk into your","italic":false}]','[{"text":"own trap...","italic":false}]']}}}}
