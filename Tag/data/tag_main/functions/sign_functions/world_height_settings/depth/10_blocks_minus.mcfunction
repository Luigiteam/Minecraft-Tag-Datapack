scoreboard players remove minDepth Numbers 10

execute if score minDepth Numbers matches ..-31 run tellraw @s "You cannot have the depth any lower than -30 blocks"
