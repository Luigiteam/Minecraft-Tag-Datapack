...
execute if score Selection optionsSelect matches 3 if score num optionsSelect matches 0 at @e[tag=spawn,type=marker] run setblock ~2 ~2 ~-3 mangrove_button[facing=south]
...
execute if score Selection optionsSelect matches 3 if score num optionsSelect matches 1 at @e[tag=spawn,type=marker] run setblock ~2 ~2 ~-3 birch_button[facing=south]
...
execute if score Selection optionsSelect matches 4 if score num optionsSelect matches 0 at @e[tag=spawn,type=marker] run playsound block.note_block.bit block @a ~ ~ ~ 100 2.0
...
execute if score Selection optionsSelect matches 4 if score num optionsSelect matches 1 at @e[tag=spawn,type=marker] run playsound block.note_block.bit block @a ~ ~ ~ 100 0.1
