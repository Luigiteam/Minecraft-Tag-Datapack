...
execute at @s run tag @p[tag=tagger,advancements={tag_main:tagger_hit_check=true},limit=1] add runner
execute at @s run tag @p[tag=tagger,advancements={tag_main:tagger_hit_check=true},limit=1] remove tagger
